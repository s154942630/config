...
static const int smartgaps          = 2;        /* 1 means no outer gap when there is only one window */
...
/* tagging */
static const char *tags[] = { "st", "konsole", "firefox", "chrome", "5", "6", "7", "8", "9" };
...
static const Layout layouts[] = {
	...
	{ "leader",      tile },    /* first entry is default */
	{ "title",      NULL },    /* no layout function means floating behavior */
	{ "[M]",      monocle },
};
...
static const char *ranger[] = { "/home/qj/Script/ranger.sh", NULL };
